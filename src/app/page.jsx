    ...
    <>
      <div className="home_bg w-full md:flex  h-screen bg-black" >
        <div className="md:w-1/2 pl-12 pt-[90px] md:pt-0 h-1/2 md:h-full flex text-white items-center">
          <div>
            <motion.div
              ...
              <button className=" md:w-[14vw] text-[14px] rounded-full text-white font-bold my-6 px-3 p-2 bg-black"><span className="flex items-center justify-center"><span className="mr-3 hover:mr-6 transition-all duration-200 ease-linear hover:text-gray-200">View Project </span>
        ...
        <div className=" md:w-1/2 md:pr-12 h-1/2 md:h-full flex text-white justify-center md:items-center">
          ...
          <motion.div
            className=" w-[180px] md:w-[300px] h-[180px] md:h-[300px] border-2 border-cyan-300 rounded-full flex justify-center nter"
